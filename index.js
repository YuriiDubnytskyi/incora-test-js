...
class SuperAdmin extends User {
	...
	createCasino(name){
		if(this.casinoArr.some(el => el.name === name) || casinoCity.some(el => el.name === name)){
...
admin2.setMoneyToGameMachine(10000,'CasinoA2',3)
admin2.setMoneyToGameMachine(-10000,'CasinoA2',1)
admin2.setMoneyToGameMachine(10000,'CasinoA2',1)

console.log('---------admin3-------------')
const admin3 = new SuperAdmin('Admin3',50000)
admin3.createCasino('CasinoA3')
admin3.setMoneyToCasino(30000,'CasinoA3')
admin3.createGameMachine(10000,'CasinoA3')
admin3.setMoneyToGameMachine(10000,'CasinoA3',1)
admin3.createGameMachine(4000,'CasinoA3')
admin3.setMoneyToGameMachine(4000,'CasinoA3',2)
admin3.deleteGameMachineByNumber('CasinoA3',4)
admin3.deleteGameMachineByNumber('CasinoA3',1)
admin3.getMoneyFromCasino(15000,'CasinoA3')
admin3.getMoneyFromCasino(1500000,'CasinoA3')
